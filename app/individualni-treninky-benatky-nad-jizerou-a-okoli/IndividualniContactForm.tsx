...
export function IndividualniContactForm() {
  ...
  if (state === "success") {
    return (
      <p style={{ fontSize: "1.1rem", lineHeight: 1.7, color: "var(--color-text)" }}>
        Moc děkuji za tvůj zájem o cvičení! Během pár dnů ti odpovím na email. Kontroluj prosím i hromadnou poštu a SPAM.
      </p>
    );
  }
  ...
  return (
    <form className={styles.contactForm} onSubmit={handleSubmit}>
      ...
      >
        {state === "submitting" ? "Odesílám…" : "Chci trénovat s Ivou"}
      </button>
    </form>
  );
}
